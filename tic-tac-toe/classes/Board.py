class Board:
    ...
    def is_move_valid(self, move): 
        #ex 1A
        # we are checking if the move has an length of 2 and if its valid we move
        move_check = ((len(move) == 2) and (int(move[0]) in Board.ROWS) and (move[1] in Board.COLUMNS))
        return move_check
    ...
    def submit_move(self, move, player):
        if not self.is_move_valid(move):
            ...
            if value == Board.EMPTY:
                ...
                print("This space is alrady taken")
